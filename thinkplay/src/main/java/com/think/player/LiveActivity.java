...
/**
 * Created by jun.wu on 2016/6/29.
 */
public class LiveActivity extends Activity implements BVideoView.OnPreparedListener, BVideoView.OnCompletionListener,
        BVideoView.OnErrorListener, BVideoView.OnInfoListener, BVideoView.OnPlayingBufferCacheListener,View.OnClickListener
{
     ...
     */
    private String AK = "b0f03099694d45ed87160916a978e901";
    ...
    private  enum  PLAYER_EVENT{
        PLAYER_BUFFER,PLAYER_PLAYING
    }
    private PLAYER_EVENT   mPlayerEvent = PLAYER_EVENT.PLAYER_BUFFER;
    /**
     * 记录播放位置
     */
    ...
    public void onClick(View v) {
        ...
        if(v.getId() == R.id.fullscreen) {
            int action = isFullscreen ? View.SYSTEM_UI_FLAG_VISIBLE : View.SYSTEM_UI_FLAG_FULLSCREEN;
            v.setSystemUiVisibility(action);
            isFullscreen = !isFullscreen;
            int src = isFullscreen ? R.drawable.shrink : R.drawable.enlarge;
            ImageView fullscreen = (ImageView) v;
            fullscreen.setImageResource(src);
        }
    ...
    public boolean onInfo(int what, int extra) {
        ...
        switch(what){
            ...
            case BVideoView.MEDIA_INFO_BUFFERING_START:
                mPlayerEvent = PLAYER_EVENT.PLAYER_BUFFER;
                break;
            /**
             * 结束缓冲
             */
